  ...
  return [
    {
      ...
      description:
        "I am currently pursuing a Bachelor's degree in Computer Science at the University of Antioquia, where I am gaining a solid foundation in software development, algorithms, and data structures.",
    },
    {
      name: "University of Helsinki",
      role: "Student",
      date: "Nov 2023 - Dec 2023",
      certificate: "Certificate of Full Stack Open course 2023",
      description:
        "Completed the Full Stack Open 2023 course offered by the University of Helsinki, covering topics such as React, Node.js, TypeScript, GraphQL, and containerization with Docker.",
    },
    {
      name: "EF SET English Live",
      role: "Student",
      date: "31 Oct 2023",
      certificate: "EF SET English Certificate C1 Advanced",
      description:
        "Achieved a C1 Advanced level certification in English through the EF Standard English Test (EF SET), demonstrating proficiency in reading and listening comprehension.",
    },
  ];
}
